  ...
  <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
      <div class="nav">
        ...
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#postLayout" aria-expanded="false"
          aria-controls="postLayout">
          <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
          Item Posting
          <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
        </a>
        <div class="collapse" id="postLayout" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
          <nav class="sb-sidenav-menu-nested nav">
            <a class="nav-link" href="{{ route('post.index') }}">Daftar Subkategori</a>
            <a class="nav-link" href="{{ route('post.create') }}">Tambah Subkategori</a>
            <a class="nav-link" href="{{ route('post.trash') }}">Tong Sampah Subkategori</a>
          </nav>
        </div>
